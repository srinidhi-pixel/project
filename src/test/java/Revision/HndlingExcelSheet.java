...
public class HndlingExcelSheet {
	@Test
...
//		XSSFCell worksheet= new XSSFWorkbook(fs).getSheetAt(0).getRow(1).getCell(0);
//		XSSFCell worksheet1= new XSSFWorkbook(fs).getSheetAt(0).getRow(1).getCell(1);
		FileInputStream fs = new FileInputStream("C:\\Users\\ACS\\Desktop\\New Microsoft Excel Worksheet.xlsx");
